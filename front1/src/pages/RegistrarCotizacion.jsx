      ...
      <div className="content">
        ...
        <div className="contenido-modulo">
          ...
          <div className="buttons">
            ...
            <button className="btn btn-primary-danger" onClick={() => handleGuardarCotizacion(false)}>Guardar</button>
            <button className="btn btn-primary-success" onClick={() => handleGuardarCotizacion(true)}>Guardar y Enviar</button>
          </div>
        </div>
      </div>
    </div>
